...
if ( ! function_exists( 'quark_setup' ) ) {
	function quark_setup() {
		...
		add_image_size( 'post_feature_full_width', 792, 350, true );
...
function quark_widgets_init() {
	...
	register_sidebar( array(
			'name' => esc_html__( 'Linker Startseitenbanner', 'quark' ),
			'id' => 'frontpage-banner1',
			'description' => esc_html__( 'Linker Banner auf der Startseite. Könnte zum Beispiel Video sein', 'quark' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Linker Startseitenbannert', 'quark' ),
			'id' => 'frontpage-banner2',
			'description' => esc_html__( 'Linker Banner auf der Startseite. Könnte zum Beispiel Call to Action sein', 'quark' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h1 class="widget-title">',
			'after_title' => '</h1>'
...
if ( ! function_exists( 'quark_get_credits' ) ) {
	function quark_get_credits() {
		...
		$output .= ' | <a href="http://freifunk.net/">Freifunk.net</a>';
...
function quark_theme_options_styles() {
	...
	$footerColour = apply_filters( 'of_sanitize_color', of_get_option( 'footer_color', '#333333' ) );
